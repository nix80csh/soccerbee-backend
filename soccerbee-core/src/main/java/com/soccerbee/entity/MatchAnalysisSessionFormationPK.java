...
/**
 * The primary key class for the match_analysis_session_formation database table.
 * 
 */
@Embeddable
public class MatchAnalysisSessionFormationPK implements Serializable {
	...
	public MatchAnalysisSessionFormationPK() {
	}
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof MatchAnalysisSessionFormationPK)) {
			return false;
		}
		MatchAnalysisSessionFormationPK castOther = (MatchAnalysisSessionFormationPK)other;
		return 
