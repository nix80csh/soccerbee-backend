...
/**
 * The persistent class for the _uniform database table.
 * 
 */
@Entity
@Table(name="_uniform")
@NamedQuery(name="_Uniform.findAll", query="SELECT _ FROM _Uniform _")
public class _Uniform implements Serializable {
